...
\begin{document}
	...
	\begin{multicols*}{3}
		...
		- no-op instruction instead (\texttt{nop}) (this is without branch prediction)\\

		\highlight{NOTE}: Branch prediction and delayed branching can be implemented together. EG. without early branching, 3 delay slots, can find 2 non-control dependent instructions, last instruction will come from predicted branch, if wring prediction, flush \red{just that 1 instruction}.\\
